...
class PatrouilleEditComponent extends Component {
    ...
    loadPatrouille = () => {
        patrouilleService.getPatrouilleById(window.localStorage.getItem("idPatrouille"))
            .then((res) => {
...
saveRavitaillement = (e) => {
    ...
    patrouilleService.createOperation(ravitaillement)
        .then(res => {
            this.setState({message :'patrouille modifié'});
...
export default withStyles(styles) (PatrouilleEditComponent);